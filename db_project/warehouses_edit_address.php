...
<head>
	...
	<link rel="stylesheet" href="css/warehouses_edit_address.css">
    ...
    <body>
		...
		<div class="container" id="main">
			...
			<div  id="contentBox" >
					<?php include 'warehouses_edit_address_content.php';?>				
			</div>
			<ul class="bubbles">
		...
		<script type="text/javascript" src="js/edit_address_warehouses.js"></script> 
    </body>
</html>