...
<head>
    ...
    <body>
		...
		<div class="container" id="main">
			...
			<script type="text/javascript" src="js/navbar_products.js"></script> 
			<div  id="contentBox" >
					<?php include 'category_add_content.php';?>				
			</div>
			<ul class="bubbles">
		...
		<script type="text/javascript" src="js/add_category.js"></script> 
    </body>
</html>