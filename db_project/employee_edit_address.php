...
<head>
	...
	<link rel="stylesheet" href="css/employee_edit_address.css">
    ...
    <body>
		...
		<div class="container" id="main">
			...
			<div  id="contentBox" >
					<?php include 'employee_edit_address_content.php';?>				
			</div>
			<ul class="bubbles">
		...
		<script type="text/javascript" src="js/edit_address_employee.js"></script> 
    </body>
</html>