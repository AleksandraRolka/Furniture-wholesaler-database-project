...
<head>
	...
	<link rel="stylesheet" href="css/producers_add.css">
    ...
    <body>
		...
		<div class="container" id="main">
			...
			<script type="text/javascript" src="js/navbar_producers.js"></script> 
			<div  id="contentBox" >
					<?php include 'producers_add_content.php';?>				
			</div>
			<ul class="bubbles">
		...
		<script type="text/javascript" src="js/add_producers.js"></script> 
    </body>
</html>