    ...
    <body>
		...
		<div class="container" id="main">
			<div class="sidenav" id="sidenav">
				...
				<!-- <a class="role" id="role">Zalogowany jako: <span id="roleName"  onclick="window.location.href='personal.php';">  </span></a> -->
			...
			<script type="text/javascript" src="js/navbar_main.js"></script> 
			<div  id="contentBox" >
					<?php include 'content00.php';?>
			</div>
			<ul class="bubbles">
